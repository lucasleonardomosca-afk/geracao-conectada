    ...
    <section className="py-24 bg-slate-900 text-white relative overflow-hidden no-print">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
         ...
         <div className="text-center">
             <button className="bg-green-500 hover:bg-green-400 text-slate-900 text-xl md:text-2xl font-bold py-6 px-12 rounded-2xl shadow-[0_0_30px_rgba(34,197,94,0.3)] transition-all hover:scale-105">
